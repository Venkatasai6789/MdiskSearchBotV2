...
class Config(object):
    API_ID = int(os.getenv("API_ID", "24330005"))
    API_HASH = os.getenv("API_HASH", "f7b37cb26bd04ab9e43f57ac269288e3")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "5677997796:AAGAAbLeEKzKLnuerTTG_phdxXkSgriwRdw")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "mdisksearchbotv2")
    USER_SESSION_STRING = os.getenv("USER_SESSION_STRING", "1BVtsOKkBu5UYx9nfW9UsqR0eiJ3jK39CrmuUdyZwOlBDNhfYbtjEzcxYT0wMc5WCA5_yMNcwJyXvPY9OQ7M81E1gsPKxr1CrKpDOUR0NWHnDEvw3Q6lFwvXEmof-Km2F0FzoeTtJxNLntlWnupYwv0Wt1RtfNBboKgVmRDxyOZ_iUtFrEvcJhiTbnR80aFiiGiP7lxkU5sDmwUmwJKu5_SBoMJG2EzKEGQ-YzBLQ0G8nekcIZU1DNlvmO6m9mOEzeivcZEUQtupKOWs4CzAMCtnwRl1ayY_g9n-AXjpTs2mSE-IVI9k1KUUaEnhWKPFgBrV9d-7xh5b-AtreJroNYmyxxlIYAaA=")
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001893892318")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "KOTHIMEER_KATTA_MDisk_Search_Bot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "1559728293"))
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "Venkatasai6789")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "backup channel test")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001893892318")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://MdiskSearchBotV2:Search1234@mdisksearchbot.txd8pi5.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001842949754"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "KOTHIMEER KATTA AHA")
    FORCE_SUB = os.getenv("FORCE_SUB", "True")
    AUTO_DELETE_TIME = int(os.getenv("AUTO_DELETE_TIME", 180))
    MDISK_API = os.getenv("MDISK_API", "Klx1RAkFonSpkurA9eS9")
...
ᴅᴍ ꜰᴏʀ ᴀɴʏ Qᴜᴇʀʏ @Venkatasai6789 🤖""" )
    ABOUT_WATCH_TEXT = """
ʜᴇʏ ʙᴜᴅᴅʏ, 
