...
class Config(object):
    ...
    BOT_TOKEN = os.getenv("BOT_TOKEN", "5987728280:AAEOrXI45MoZuBaz8NhLreKBW0AWQ2S6jPI")
    ...
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001851646892")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "KOTHIMEER_KATTA_MDisk_Search_Bot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "5912611393"))
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "Venkatasai6789")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "Backup channel")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001851646892")
    ...
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001551104274"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "KK Movies")
